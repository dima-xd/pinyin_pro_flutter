...
// Source: pinyin-pro/lib/data/dict3.ts
...
/// 3-character word to pinyin mapping.
const Map<String, String> _dict3Data = {
  '为什么': 'wèi shén me',
  '实际上': 'shí jì shang',
  '检察长': 'jiǎn chá zhǎng',
  '干什么': 'gàn shén me',
...
List<Pattern> buildDict3Patterns() {
  return _dict3Data.entries.map((e) => Pattern(
    zh: e.key,
    pinyin: e.value,
    probability: kProbabilityDict * 3 * 3,
    length: 3,
